...
public class RecyclerAdapter_1 extends RecyclerView.Adapter <RecyclerAdapter_1.recyclerViewViewHolder>{
    ...
    public  RecyclerAdapter_1  (ArrayList<data_provider_1> arrayList, Context context ){
    ...
    public  recyclerViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_item_layout_1,parent,false); // // don't ever use
        // // fucking context
    ...
    public  class   recyclerViewViewHolder  extends RecyclerView.ViewHolder {
        ...
        public recyclerViewViewHolder(View view) {
            ...
            parentlayout = (RelativeLayout) view.findViewById(R.id.rel_1);
            parentlayout2= (RelativeLayout) view.findViewById(R.id.rel_2);
