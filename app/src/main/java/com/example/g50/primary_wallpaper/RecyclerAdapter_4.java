...
public class RecyclerAdapter_4 extends RecyclerView.Adapter <RecyclerAdapter_4.recyclerViewViewHolder>{

    public Context context;
    private ArrayList<data_provider_1> arrayList = new ArrayList<data_provider_1>();




    public  RecyclerAdapter_4 (ArrayList<data_provider_1> arrayList, Context context ){
    ...
    public  recyclerViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_item_layout_4,parent,false); // // don't ever use
        // // fucking context
    ...
    public void onBindViewHolder(recyclerViewViewHolder holder , final int position) {
        ...
        final data_provider_1  data_provider =arrayList.get(position);
    ...
    public  class   recyclerViewViewHolder  extends RecyclerView.ViewHolder {
        ...
        public recyclerViewViewHolder(View view) {
            ...
            imageView1 = (ImageView) view.findViewById(R.id.imageview_4_1);
            imageView2 = (ImageView) view.findViewById(R.id.imageview_4_2);
            parentlayout = (RelativeLayout) view.findViewById(R.id.rel_4_1);
            parentlayout2= (RelativeLayout) view.findViewById(R.id.rel_4_2);
