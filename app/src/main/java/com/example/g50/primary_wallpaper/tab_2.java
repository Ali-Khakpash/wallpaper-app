...
public class tab_2 extends Fragment {
    ...
    private ArrayList<data_provider_2> data  ;
    private String url1;
    private String url2;
    private String url3;
    private String url4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_tab_2, container, false);
        mProgressBar = (ProgressBar) layout.findViewById(R.id.progress_bar);
        recyclerView= (RecyclerView)layout.findViewById(R.id.recyclerview2);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(layoutManager);
        mProgressBar.setVisibility(View.VISIBLE);
        data = new ArrayList<data_provider_2>();
        jsonparse();
        return layout;
    }
    ...
    // https://www.jasonbase.com/things/kgV5

    private void jsonparse(){

        final String url  = " https://www.jasonbase.com/things/o0Gr";

        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,    // // // this Could be a  JsonArrayRequest
                new Response.Listener<JSONArray>() {                                                              //or ObjectRequest
                    @Override
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i =0 ; i<response.length();i++) {
                                ...
                                for (int j = 0 ; j<2; j++) {
                                    ...
                                    if(j==0) {
                                        ...
                                        data .add(new data_provider_2(url1,url2));
                                    ...
                                    if(j==1) {
                                        ...
                                        data .add(new data_provider_2(url3,url4));
                                    }
                            ...
                            adapter = new RecyclerAdapter_2(data,getContext());
