...
public class RecyclerAdapter_3 extends RecyclerView.Adapter <RecyclerAdapter_3.recyclerViewViewHolder>{
    ...
    public  RecyclerAdapter_3 (ArrayList<data_provider_1> arrayList, Context context ){
    ...
    public  recyclerViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_item_layout_3,parent,false); // // don't ever use
        // // fucking context
    ...
    public  class   recyclerViewViewHolder  extends RecyclerView.ViewHolder {
        ...
        public recyclerViewViewHolder(View view) {
            ...
            imageView1 = (ImageView) view.findViewById(R.id.imageview_3_1);
            imageView2 = (ImageView) view.findViewById(R.id.imageview_3_2);
            parentlayout = (RelativeLayout) view.findViewById(R.id.rel_3_1);
            parentlayout2= (RelativeLayout) view.findViewById(R.id.rel_3_2);
