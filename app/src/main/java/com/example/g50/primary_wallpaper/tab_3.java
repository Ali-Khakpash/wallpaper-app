...
public class tab_3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_tab_3, container, false);
        mProgressBar = (ProgressBar) layout.findViewById(R.id.progress_bar);
        recyclerView= (RecyclerView)layout.findViewById(R.id.recyclerview3);
    ...
    private void jsonparse(){
        ...
        final String url  = "  https://www.jasonbase.com/things/wwB5 ";
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            adapter = new RecyclerAdapter_3(data,getContext());
